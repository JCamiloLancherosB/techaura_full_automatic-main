...
export type LogCategory = 'system' | 'chatbot' | 'database' | 'ai' | 'whatsapp' | 'api' | 'flow' | 'notificador' | 'order-events' | 
    ...
    'processing_cleanup' | 'message_outside_hours' | 'stuck_processing_detected' | 'already_processing' | 'deduplication' | 'dedup_skipped' | 'processing-jobs' | 'analytics' | 'rag' | 'shipping';
